  ...
  return (
      <View style={styles.container}>
        ...
        <View style={styles.overlay}>
          ...
          <Text style={styles.subHeadings}>Trending Communities</Text>
          <View style={styles.trendingHolder}>
            <View style={styles.trending}>
              <Text style={styles.trendingText}>Seattle</Text>
            </View>
            <View style={styles.trending}>
              <Text style={styles.trendingText}>Arab</Text>
            </View>
            <View style={styles.trending}>
              <Text style={styles.trendingText}>Tech</Text>
            </View>
